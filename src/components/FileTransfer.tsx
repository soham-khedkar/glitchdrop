...
const FileTransfer = () => {
  ...
  const onDrop = useCallback(async (acceptedFiles: File[]) => {
    try {
      ...
      if (metadataError) {
        throw new Error(`Failed to save transfer metadata: ${metadataError.message}`);
      }
    } catch (err) {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="mb-8 text-center">
        <h1 className="text-4xl font-bold text-gray-800 mb-4">SecureShare</h1>
        <p className="text-gray-600">End-to-end encrypted file transfer with resumable uploads</p>
      </div>
      ...
      {transferId && (
        <div className="mt-8 p-6 bg-green-50 rounded-lg">
          <div className="flex items-center mb-4">
            ...
            <h2 className="text-xl font-semibold text-green-800">File Ready for Transfer</h2>
          </div>
          <p className="text-green-700 mb-4">Share this transfer ID with the recipient:</p>
